                ...
                <div class="panel-body">
                    <form class="form-group" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group pull-right">
                            <img src="${pageContext.request.contextPath}/userImage?email=${user.email}" class="img-responsive" style="width:95px;height:95px;">
                        </div>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label> E-mail </label> <input type="email" class="form-control"
                                                       name="email" value="${user.email}" id="email" disabled>

                    </div>

                    <div class="form-group">
                        <label>Your District </label> <input list="districts" type="text"
                                                             class="form-control" name="districtName" value="${user.district}"
                                                             id="districtReg">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="securityQuestion" id="securityQuestion" value="${user.securityQuestion}">
