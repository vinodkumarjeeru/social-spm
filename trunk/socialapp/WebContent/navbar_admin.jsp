<nav class="navbar navbar-fixed-top navbar-default navbar-inverse">
	...
	<div id="NavbarCollapse" class="collapse navbar-collapse">
		...
		<div class="pull-right">
			<b class="navbar-text text-muted pull-right">Administrator</b> <b><a
				href="#" class="btn-sm btn-danger text-success" id="LogOut"
				style="position: relative; top: 15px; left: -4px;">Log Out</a></b>
		</div>
	</div>
